...
function OtherUpload(Props) {
  ...
  var tmp$3;
  if (Setting$BtsCore.disabledObjects(showFile)) {
    var tmp$4 = {
      variant: "button",
      color: "rgba(255,255,255,1)",
      border: "contained",
    ...
    if (onDownload !== undefined) {
      tmp$4.onClick = Caml_option.valFromOption(onDownload);
    }
    tmp$3 = React.createElement(Button$BtsCore.make, tmp$4);
  } else {
    tmp$3 = null;
  }
  var tmp$5 = {
  ...
  if (onChange !== undefined) {
    tmp$5.onChange = Caml_option.valFromOption(onChange);
  }
  return React.createElement(PasteBoard$BtsCore.make, tmp, tmp$1, React.createElement(Button$BtsCore.make, tmp$2), tmp$3, React.createElement("input", tmp$5));
}
