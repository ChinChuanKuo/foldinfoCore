...
function MailistR(Props) {
  ...
  var clickItemTab = React.useCallback((function (i) {
          if (i === 1) {
            return ReasonReactRouter.push(Path$BtsCore.mailistFPath);
          } else if (i === 2) {
  ...
  var clickFormBoard = React.useCallback((function (value) {
          ...
          Axiosapi$BtsCore.MailistR.sItem(Data$BtsCore.otherData(localStorage.getItem("newid"), value)).then((function (response) {
                    var match = response.data.status;
                    var tmp;
                    if (match === "istrue") {
  ...
  var insertForm = React.useCallback((function (param) {
          Curry._1(dispatch, /* ActionShowProgress */2);
          Axiosapi$BtsCore.MailistR.insert(Data$BtsCore.iFormData(state.formId, state.formTitle, state.formitems.filter((function (formitem) {
