...
function newitem(iid, groupitems) {
  return [{
            iid: iid,
            group: "",
            showGroupMenu: false,
    ...
    switch (action.tag | 0) {
      ...
      case /* AddForm */4 :
          return {
                  ...
                  tabitems: state.tabitems,
                  index: state.index,
                  items: $$Array.append(state.items, newitem(String(Caml_format.caml_int_of_string(Caml_array.caml_array_get(state.items, state.items.length - 1 | 0).iid) + 1 | 0), action[0])),
                  showYoutube: state.showYoutube,
                  youtubeText: state.youtubeText
                };
...
function SendistR(Props) {
  ...
  var searchAJax = function (param) {
    Axiosapi$BtsCore.SendistR.search(Data$BtsCore.userData(localStorage.getItem("newid"))).then((function (response) {
  ...
  var addForm = React.useCallback((function (param) {
          ...
          Axiosapi$BtsCore.SendistR.add(Data$BtsCore.userData(localStorage.getItem("newid"))).then((function (response) {
                    return Promise.resolve((Curry._1(dispatch, /* AddForm */Block.__(4, [response.data.items])), Curry._1(dispatch, /* ActionShowProgress */2)));
                  })).catch((function (error) {
                  return Promise.resolve((console.log(error), undefined));
                }));
  ...
  var insertForm = React.useCallback((function (param) {
          Curry._1(dispatch, /* ActionShowProgress */2);
          Axiosapi$BtsCore.SendistR.insert(Data$BtsCore.iItemsData(state.items.filter((function (item) {
  ...
  var clickGroupMenu = React.useCallback((function (value) {
          return (function (i) {
              ...
              Axiosapi$BtsCore.SendistR.sGroup(Data$BtsCore.otherData(localStorage.getItem("newid"), value)).then((function (response) {
