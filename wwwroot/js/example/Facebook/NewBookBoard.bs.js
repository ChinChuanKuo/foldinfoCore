  ...
  /* :: */[
    {
      ...
      tabTip: "工廠內部通告",
      tabPath: Path$BtsCore.insidePath
    },
    /* :: */[
      {
        showTab: false,
        ...
        tabTip: "ISO三階文件",
        tabPath: Path$BtsCore.isoFilePath
      },
      /* :: */[
        {
          showTab: false,
          ...
          tabTip: "生產注意事項",
          tabPath: Path$BtsCore.productPath
        },
        /* :: */[
          {
            showTab: false,
            tabImage: Icons$BtsCore.homeBlack,
            tabTip: "簽核總列表",
            tabPath: Path$BtsCore.signlistPath
          },
          /* [] */0
        ]
      ]
...
function NewBookBoard(Props) {
  ...
  var createForm = React.useCallback((function (param) {
          ...
          return ReasonReactRouter.push(Path$BtsCore.createRPath);
        }));
  var contactsForm = React.useCallback((function (param) {
          Curry._1(dispatch, /* ClickItemTab */Block.__(6, [-1]));
          Curry._1(dispatch, /* ShowCreate */1);
          return ReasonReactRouter.push(Path$BtsCore.createFPath);
        }));
  var assistantForm = React.useCallback((function (param) {
          Curry._1(dispatch, /* ClickItemTab */Block.__(6, [-1]));
          Curry._1(dispatch, /* ShowCreate */1);
          return ReasonReactRouter.push(Path$BtsCore.createIPath);
        }));
  var flagForm = React.useCallback((function (param) {
          Curry._1(dispatch, /* ClickItemTab */Block.__(6, [-1]));
          Curry._1(dispatch, /* ShowCreate */1);
          return ReasonReactRouter.push(Path$BtsCore.createPPath);
        }));
