...
function CreateP(Props) {
  ...
  var searchAJax = function (param) {
    Axiosapi$BtsCore.CreateP.search(Data$BtsCore.userData(localStorage.getItem("newid"))).then((function (response) {
  ...
  var insertForm = React.useCallback((function (param) {
          ...
          Axiosapi$BtsCore.CreateP.insert(Data$BtsCore.iItemsData(state.items, localStorage.getItem("newid"))).then((function (response) {
                    var match = response.data.status;
                    var tmp;
                    if (match === "istrue") {
                      sessionStorage.setItem("form", "saveSuccess");
                      tmp = ReasonReactRouter.push(Path$BtsCore.productPath);
                    } else {
                      barShowRestoreAction(Status$BtsCore.statusModule(response.data.status));
                      tmp = Curry._1(dispatch, /* ActionShowProgress */2);
                    }
  ...
  var showGroupMenu = React.useCallback((function (i) {
          return Curry._1(dispatch, /* ShowGroupMenu */Block.__(3, [i]));
        }));
  var clickGroupMenu = React.useCallback((function (value) {
          return (function (i) {
              Curry._1(dispatch, /* ClickGroupMenu */Block.__(4, [
                      value,
                      i
                    ]));
              Axiosapi$BtsCore.CreateP.sGroup(Data$BtsCore.otherData(localStorage.getItem("newid"), value)).then((function (response) {
                        return Promise.resolve(Curry._1(dispatch, /* SettingItemName */Block.__(6, [
                                          response.data.items,
                                          i
                                        ])));
                      })).catch((function (error) {
  ...
  var showNameMenu = React.useCallback((function (i) {
          return Curry._1(dispatch, /* ShowNameMenu */Block.__(5, [i]));
        }));
  var clickNameMenu = React.useCallback((function (value) {
          return (function (i) {
              return Curry._1(dispatch, /* ClickNameMenu */Block.__(7, [
                            value,
                            i
                          ]));
            });
  ...
  var changeSubject = React.useCallback((function (value) {
          return (function (i) {
              return Curry._1(dispatch, /* ChangeSubject */Block.__(8, [
                            value,
                            i
                          ]));
            });
  ...
  var changeMomo = React.useCallback((function (value) {
          return (function (i) {
              return Curry._1(dispatch, /* ChangeMomo */Block.__(9, [
                            value,
                            i
                          ]));
            });
  ...
  var clearMbItem = React.useCallback((function (mbId) {
          return (function (i) {
              return Curry._1(dispatch, /* ClearMbItem */Block.__(10, [
                            mbId,
                            i
                          ]));
            });
  ...
  var showMtstMenu = React.useCallback((function (i) {
          return Curry._1(dispatch, /* ShowMtstMenu */Block.__(11, [i]));
        }));
  var clickMtstMenu = React.useCallback((function (value) {
          return (function (i) {
              Curry._1(dispatch, /* ClickMtstMenu */Block.__(12, [
                      value,
                      i
                    ]));
              Axiosapi$BtsCore.CreateP.sModel(Data$BtsCore.otherData(localStorage.getItem("newid"), value)).then((function (response) {
                        return Promise.resolve(Curry._1(dispatch, /* SettingItemModel */Block.__(14, [
                                          response.data.items,
                                          i
                                        ])));
                      })).catch((function (error) {
  ...
  var showMbstMenu = React.useCallback((function (i) {
          return Curry._1(dispatch, /* ShowMbstMenu */Block.__(13, [i]));
        }));
  var clickMbstMenu = React.useCallback((function (value) {
          return (function (i) {
              Curry._1(dispatch, /* ClickMbstMenu */Block.__(16, [
                      value,
                      i
                    ]));
              return Curry._1(dispatch, /* AddMbItem */Block.__(15, [
                            value,
                            i
                          ]));
            });
  ...
  var clearPageItem = React.useCallback((function (mbId) {
          return (function (i) {
              return Curry._1(dispatch, /* ClearPageItem */Block.__(17, [
                            mbId,
                            i
                          ]));
            });
  ...
  var changeCustom = React.useCallback((function (value) {
          return (function (i) {
              Curry._1(dispatch, /* ChangeCustom */Block.__(20, [
                      value,
                      i
                    ]));
              Axiosapi$BtsCore.CreateP.sCustom(Data$BtsCore.otherData(localStorage.getItem("newid"), value)).then((function (response) {
                        return Promise.resolve(Curry._1(dispatch, /* SettingItemCustom */Block.__(19, [
                                          response.data.items,
                                          i
                                        ])));
                      })).catch((function (error) {
          ...
          return (function (value, i) {
              if (keyCode === 13) {
                Axiosapi$BtsCore.CreateP.cCustom(Data$BtsCore.otherData(localStorage.getItem("newid"), value)).then((function (response) {
                          ...
                          var tmp;
                          if (match === "istrue") {
                            Curry._1(dispatch, /* ClickItemCustom */Block.__(21, [i]));
                            tmp = Curry._1(dispatch, /* AddCustomItem */Block.__(22, [
                                    value,
                                    i
                                  ]));
                          } else {
  ...
  var showCustom = React.useCallback((function (i) {
          return Curry._1(dispatch, /* ShowCustom */Block.__(18, [
                        false,
                        i
                      ]));
        }));
  var clickItemCustom = React.useCallback((function (value) {
          return (function (i) {
              Curry._1(dispatch, /* ClickItemCustom */Block.__(21, [i]));
              return Curry._1(dispatch, /* AddCustomItem */Block.__(22, [
                            value,
                            i
                          ]));
            });
  ...
  var dragOverFile = React.useCallback((function ($$event) {
          return (function (i) {
              ...
              return Curry._1(dispatch, /* ShowDrop */Block.__(23, [
                            true,
                            i
                          ]));
            });
  ...
  var uploadAJax = function (files, i) {
    ...
    Axiosapi$BtsCore.Files.upload(formData).then((function (response) {
              ...
              var tmp;
              if (match === "istrue") {
                Curry._1(dispatch, /* ShowFile */Block.__(24, [
  ...
  var dropFile = React.useCallback((function ($$event) {
          return (function (value, i) {
              ...
              $$event.stopPropagation();
              Curry._1(dispatch, /* ActionShowProgress */2);
              Curry._1(dispatch, /* ShowDrop */Block.__(23, [
                      false,
                      i
                    ]));
  ...
  var transForm = React.useCallback((function (path) {
          return (function (original, encryption, extension, i) {
              ...
              Axiosapi$BtsCore.Files.transfer(Data$BtsCore.sFileData(path, original, encryption, extension, localStorage.getItem("newid"))).then((function (response) {
                        ...
                        var tmp;
                        if (match === "istrue") {
                          Curry._1(dispatch, /* ShowPdfFile */Block.__(26, [
                                  response.data.images,
                                  response.data.videos,
                                  response.data.audios,
                                  response.data.src,
  ...
  var dragOverPdfFile = React.useCallback((function ($$event) {
          return (function (i) {
              $$event.preventDefault();
              $$event.stopPropagation();
              return Curry._1(dispatch, /* ShowPdfDrop */Block.__(25, [
                            true,
                            i
                          ]));
            });
  ...
  var dropPdfFile = React.useCallback((function ($$event) {
          return (function (value, i) {
              ...
              $$event.stopPropagation();
              Curry._1(dispatch, /* ActionShowProgress */2);
              Curry._1(dispatch, /* ShowPdfDrop */Block.__(25, [
                      false,
                      i
                    ]));
  ...
  var totalForm = React.useCallback((function (path) {
          return (function (original, encryption, extension, i) {
              ...
              Axiosapi$BtsCore.Files.total(Data$BtsCore.sFileData(path, original, encryption, extension, localStorage.getItem("newid"))).then((function (response) {
                        ...
                        var tmp;
                        if (match === "istrue") {
                          Curry._1(dispatch, /* ShowTotal */Block.__(27, [
                                  response.data.value,
                                  i
                                ]));
                          tmp = Curry._1(dispatch, /* ActionShowProgress */2);
  ...
  var changeFirst = React.useCallback((function (value) {
          return (function (i) {
              return Curry._1(dispatch, /* ChangeFirst */Block.__(28, [
                            value,
                            i
                          ]));
            });
  ...
  var changeFinal = React.useCallback((function (value) {
          return (function (i) {
              return Curry._1(dispatch, /* ChangeFinal */Block.__(29, [
                            value,
                            i
                          ]));
            });
  ...
  var removeFile = React.useCallback((function (path) {
          return (function (original, encryption, extension, first, $$final, i) {
              ...
              Axiosapi$BtsCore.Files.remove(Data$BtsCore.rFileData(path, original, encryption, extension, first, $$final, localStorage.getItem("newid"))).then((function (response) {
                        ...
                        var tmp;
                        if (match === "istrue") {
                          Curry._1(dispatch, /* RemovePage */Block.__(30, [
                                  response.data.value,
                                  i
                                ]));
                          tmp = Curry._1(dispatch, /* ActionShowProgress */2);
  ...
  var changeBody = React.useCallback((function (value) {
          return (function (i) {
              return Curry._1(dispatch, /* ChangeBody */Block.__(31, [
                            value,
                            i
                          ]));
            });
