...
type action =
  ...
  | ClickItemTab(int)
  | ShowSnno(bool, int)
  | SettingItemSnno(array(optionitem), int)
  | SettingArraySnno(
      string,
      string,
      string,
  ...
  | ChangeSnno(string, int)
  | ClickItemSnno(string, int)
  | ShowGroupMenu(int)
...
let reducer = (state, action) =>
  ...
  | ShowSnno(showSnno, index) => {
      ...state,
      items:
        Array.mapi(
          (i, item) => index == i ? {...item, showSnno} : item,
          state.items,
        ),
    }
  | SettingItemSnno(items, index) => {
      ...state,
      items:
        Array.mapi(
          (i, item) =>
            index == i ? {...item, snnoitems: items, showSnno: true} : item,
          state.items,
        ),
    }
  | SettingArraySnno(
  ...
  | ChangeSnno(value, index) => {
      ...state,
      items:
        Array.mapi(
          (i, item) => index == i ? {...item, snno: value} : item,
          state.items,
        ),
    }
  | ClickItemSnno(value, index) => {
      ...state,
      items:
        Array.mapi(
          (i, item) =>
            index == i
              ? {...item, snno: value, showSnno: !item.showSnno} : item,
          state.items,
        ),
    }
  | ShowGroupMenu(index) => {
  ...
  | ClickCaseMenu(value, index) => {
      ...
      items:
        Array.mapi(
          (i, item) =>
            index == i
              ? {...item, case: value, showCaseMenu: !item.showCaseMenu}
              : item,
          state.items,
        ),
    }
  ...
  | ChangeEcr(value, index) => {
      ...
      items:
        Array.mapi(
          (i, item) => index == i ? {...item, ecr: value} : item,
          state.items,
        ),
    }
  | ChangeEcn(value, index) => {
      ...
      items:
        Array.mapi(
          (i, item) => index == i ? {...item, ecn: value} : item,
          state.items,
        ),
    }
  | ChangeEn(value, index) => {
      ...
      items:
        Array.mapi(
          (i, item) => index == i ? {...item, en: value} : item,
          state.items,
        ),
    }
  | ShowTypeMenu(index) => {
  ...
  | ChangeAction1(value, index) => {
      ...
      items:
        Array.mapi(
          (i, item) => index == i ? {...item, action1: value} : item,
          state.items,
        ),
    }
  ...
  | ChangeAction2(value, index) => {
      ...
      items:
        Array.mapi(
          (i, item) => index == i ? {...item, action2: value} : item,
          state.items,
        ),
    }
          ...
          (i, item) =>
            index == i
              ? {
                ...
                mbitems:
                  Js_array.filter(
                    (radioitem: mbitem) => radioitem.mbId !== mbId,
                    item.mbitems,
                  ),
              }
              : item,
  ...
  | ChangeOldno(value, index) => {
      ...
      items:
        Array.mapi(
          (i, item) => index == i ? {...item, oldno: value} : item,
          state.items,
        ),
    }
  | ChangeNewno(value, index) => {
      ...
      items:
        Array.mapi(
          (i, item) => index == i ? {...item, newno: value} : item,
          state.items,
        ),
    }
  | ChangeSopno(value, index) => {
      ...
      items:
        Array.mapi(
          (i, item) => index == i ? {...item, sopno: value} : item,
          state.items,
        ),
    }
  | ChangeAction3(value, index) => {
      ...
      items:
        Array.mapi(
          (i, item) => index == i ? {...item, action3: value} : item,
          state.items,
        ),
    }
  | ChangeSipno(value, index) => {
      ...
      items:
        Array.mapi(
          (i, item) => index == i ? {...item, sipno: value} : item,
          state.items,
        ),
    }
  | ChangeAction4(value, index) => {
      ...
      items:
        Array.mapi(
          (i, item) => index == i ? {...item, action4: value} : item,
          state.items,
        ),
    }
  | ChangeAction5(value, index) => {
      ...
      items:
        Array.mapi(
          (i, item) => index == i ? {...item, action5: value} : item,
          state.items,
        ),
    }
...
let make = _ => {
  ...
  let insertAJax = () =>
    Js.Promise.(
      "newid"
      |> Locals.select
      |> iSideData(state.items, state.photoitems, state.grotoitems)
      |> Axiosapi.CreateF.insert
      |> then_(response =>
           {
             switch (response##data##status) {
             | "istrue" =>
  ...
  let changeSnno =
    useCallback((value, i) => ChangeSnno(value, i) |> dispatch);

  let setTextRef: (React.Ref.t(Js.Nullable.t('b)), string) => unit = [%bs.raw
    (element, value) => {| element.current.innerHTML = value; |}
  ];

  let sSnnoAJax = (value, i) =>
    Js.Promise.(
      value
      |> otherData("newid" |> Locals.select)
      |> Axiosapi.CreateF.sSnno
      |> then_(response =>
           {
             switch (response##data##status) {
             | "istrue" =>
               SettingItemSnno(response##data##items, i) |> dispatch;
             | _ =>
               SettingArraySnno(
                 response##data##array[0].postGroup,
                 response##data##array[0].postName,
                 response##data##array[0].case,
                 response##data##array[0].homepage1,
                 response##data##array[0].pnumber,
                 response##data##array[0].obj,
                 response##data##array[0].homepageMomo,
                 response##data##array[0].mb,
                 response##data##array[0].amount,
                 response##data##array[0].subject,
                 response##data##array[0].body,
                 response##data##array[0].workitems,
                 i,
               )
               |> dispatch;
               response##data##array[0].body |> setTextRef(textRef);
             };
           }
           |> resolve
         )
  ...
  let showSnno = useCallback(i => ShowSnno(false, i) |> dispatch);

  let clickItemSnno =
    useCallback((value, i) => {
      i |> sSnnoAJax(value);
      ClickItemSnno(value, i) |> dispatch;
    });
  ...
  let clearMailItem =
    useCallback((maId, i) => ClearMailItem(maId, i) |> dispatch);
                                   ...
                                   {item.snnoitems
                                    |> Array.map(snnoitem =>
                                         <MenuItem
                                           ...
                                           onClick={_ =>
                                             i
                                             |> clickItemSnno(snnoitem.value)
                                           }>
                                           <Typography variant="subheading">
                                             {snnoitem.value |> string}
                                           </Typography>
                                         </MenuItem>
                                       )
                                    |> array}
