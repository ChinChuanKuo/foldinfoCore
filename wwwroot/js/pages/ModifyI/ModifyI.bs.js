    ...
    case /* ChangeReleaseDate */30 :
        ...
        return {
                ...
                items: $$Array.mapi((function (i, item) {
                        ...
                        var newrecord = Caml_obj.caml_obj_dup(item);
                        newrecord.formModify = true;
                        newrecord.releaseDate = value$13;
                        return newrecord;
                      }), state.items),
                showYoutube: state.showYoutube,
                youtubeText: state.youtubeText
    ...
    case /* ChangeEndDate */32 :
        ...
        return {
                ...
                items: $$Array.mapi((function (i, item) {
                        ...
                        var newrecord = Caml_obj.caml_obj_dup(item);
                        newrecord.formModify = true;
                        newrecord.endDate = value$14;
                        return newrecord;
                      }), state.items),
                showYoutube: state.showYoutube,
                youtubeText: state.youtubeText
              };
    case /* ActionSnackBar */33 :
        return {
                formLoad: state.formLoad,
                formWidth: state.formWidth,
                formHeight: state.formHeight,
...
function ModifyI(Props) {
  var match = React.useReducer(reducer, initialState);
  var dispatch = match[1];
  var state = match[0];
  var fileRef = React.useRef(null);
  var barShowRestoreAction = function (youtubeText) {
    Curry._1(dispatch, /* ActionSnackBar */Block.__(33, [
            youtubeText,
            true
          ]));
    setTimeout((function (param) {
            return Curry._1(dispatch, /* ActionSnackBar */Block.__(33, [
                          "",
                          false
                        ]));
          }), 5000);
  ...
  var orderForm = React.useCallback((function (param) {
          ...
          Axiosapi$BtsCore.IsoFile.order(Data$BtsCore.iFormData(state.formId, state.formTitle, state.items, localStorage.getItem("newid"))).then((function (response) {
                    var match = response.data.status;
                    var tmp;
                    if (match === "istrue") {
  ...
  var insertForm = React.useCallback((function (param) {
          Curry._1(dispatch, /* ActionShowProgress */1);
          Axiosapi$BtsCore.IsoFile.insert(Data$BtsCore.iFormData(state.formId, state.formTitle, state.items.filter((function (item) {
  ...
  var sendForm = React.useCallback((function (param) {
          Curry._1(dispatch, /* ActionShowProgress */1);
          Axiosapi$BtsCore.IsoFile.send(Data$BtsCore.iFormData(state.formId, state.formTitle, state.items.filter((function (item) {
                              return item.formModify === true;
                            })), localStorage.getItem("newid"))).then((function (response) {
                    var match = response.data.status;
                    var tmp;
  ...
  var changeSubject = React.useCallback((function (value) {
          return (function (i) {
              return Curry._1(dispatch, /* ChangeSubject */Block.__(4, [
                            value,
                            i
                          ]));
            });
  ...
  var showObjMenu = React.useCallback((function (i) {
          return Curry._1(dispatch, /* ShowObjMenu */Block.__(5, [i]));
        }));
  var clickObjMenu = React.useCallback((function (value) {
          return (function (i) {
              return Curry._1(dispatch, /* ClickObjMenu */Block.__(6, [
                            value,
                            i
                          ]));
            });
  ...
  var changeMomo = React.useCallback((function (value) {
          return (function (i) {
              return Curry._1(dispatch, /* ChangeMomo */Block.__(7, [
                            value,
                            i
                          ]));
            });
  ...
  var clearMbItem = React.useCallback((function (mbId) {
          return (function (i) {
              return Curry._1(dispatch, /* ClearMbItem */Block.__(8, [
                            mbId,
                            i
                          ]));
            });
  ...
  var showMtstMenu = React.useCallback((function (i) {
          return Curry._1(dispatch, /* ShowMtstMenu */Block.__(9, [i]));
        }));
  var clickMtstMenu = React.useCallback((function (value) {
          return (function (i) {
              Curry._1(dispatch, /* ClickMtstMenu */Block.__(10, [
                      value,
                      i
                    ]));
              Axiosapi$BtsCore.CreateF.sModel(Data$BtsCore.otherData(localStorage.getItem("newid"), value)).then((function (response) {
                        return Promise.resolve(Curry._1(dispatch, /* SettingItemModel */Block.__(12, [
                                          response.data.items,
                                          i
                                        ])));
                      })).catch((function (error) {
  ...
  var showMbstMenu = React.useCallback((function (i) {
          return Curry._1(dispatch, /* ShowMbstMenu */Block.__(11, [i]));
        }));
  var clickMbstMenu = React.useCallback((function (value) {
          return (function (i) {
              Curry._1(dispatch, /* ClickMbstMenu */Block.__(14, [
                      value,
                      i
                    ]));
              return Curry._1(dispatch, /* AddMbItem */Block.__(13, [
                            value,
                            i
                          ]));
            });
  ...
  var clearPageItem = React.useCallback((function (mbId) {
          return (function (i) {
              return Curry._1(dispatch, /* ClearPageItem */Block.__(15, [
                            mbId,
                            i
                          ]));
            });
  ...
  var changeCustom = React.useCallback((function (value) {
          return (function (i) {
              Curry._1(dispatch, /* ChangeCustom */Block.__(18, [
                      value,
                      i
                    ]));
              Axiosapi$BtsCore.CreateI.sCustom(Data$BtsCore.otherData(localStorage.getItem("newid"), value)).then((function (response) {
                        return Promise.resolve(Curry._1(dispatch, /* SettingItemCustom */Block.__(17, [
                                          response.data.items,
                                          i
                                        ])));
                      })).catch((function (error) {
          ...
          return (function (value, i) {
              if (keyCode === 13) {
                Axiosapi$BtsCore.CreateI.cCustom(Data$BtsCore.otherData(localStorage.getItem("newid"), value)).then((function (response) {
                          ...
                          var tmp;
                          if (match === "istrue") {
                            Curry._1(dispatch, /* ClickItemCustom */Block.__(19, [i]));
                            tmp = Curry._1(dispatch, /* AddCustomItem */Block.__(20, [
                                    value,
                                    i
                                  ]));
                          } else {
  ...
  var showCustom = React.useCallback((function (i) {
          return Curry._1(dispatch, /* ShowCustom */Block.__(16, [
                        false,
                        i
                      ]));
        }));
  var clickItemCustom = React.useCallback((function (value) {
          return (function (i) {
              Curry._1(dispatch, /* ClickItemCustom */Block.__(19, [i]));
              return Curry._1(dispatch, /* AddCustomItem */Block.__(20, [
                            value,
                            i
                          ]));
            });
  ...
  var dragOverFile = React.useCallback((function ($$event) {
          return (function (i) {
              ...
              return Curry._1(dispatch, /* ShowDrop */Block.__(21, [
                            true,
                            i
                          ]));
            });
  ...
  var uploadAJax = function (files, i) {
    ...
    Axiosapi$BtsCore.Files.upload(formData).then((function (response) {
              ...
              var tmp;
              if (match === "istrue") {
                Curry._1(dispatch, /* ShowFile */Block.__(22, [
  ...
  var dropFile = React.useCallback((function ($$event) {
          return (function (value, i) {
              ...
              $$event.stopPropagation();
              Curry._1(dispatch, /* ActionShowProgress */1);
              Curry._1(dispatch, /* ShowDrop */Block.__(21, [
                      false,
                      i
                    ]));
  ...
  var transForm = React.useCallback((function (path) {
          return (function (original, encryption, extension, i) {
              ...
              Axiosapi$BtsCore.Files.transfer(Data$BtsCore.sFileData(path, original, encryption, extension, localStorage.getItem("newid"))).then((function (response) {
                        ...
                        var tmp;
                        if (match === "istrue") {
                          Curry._1(dispatch, /* ShowPdfFile */Block.__(24, [
                                  response.data.images,
                                  response.data.videos,
                                  response.data.audios,
                                  response.data.src,
  ...
  var dragOverPdfFile = React.useCallback((function ($$event) {
          return (function (i) {
              $$event.preventDefault();
              $$event.stopPropagation();
              return Curry._1(dispatch, /* ShowPdfDrop */Block.__(23, [
                            true,
                            i
                          ]));
            });
  ...
  var dropPdfFile = React.useCallback((function ($$event) {
          return (function (value, i) {
              ...
              $$event.stopPropagation();
              Curry._1(dispatch, /* ActionShowProgress */1);
              Curry._1(dispatch, /* ShowPdfDrop */Block.__(23, [
                      false,
                      i
                    ]));
  ...
  var totalForm = React.useCallback((function (path) {
          return (function (original, encryption, extension, i) {
              ...
              Axiosapi$BtsCore.Files.total(Data$BtsCore.sFileData(path, original, encryption, extension, localStorage.getItem("newid"))).then((function (response) {
                        ...
                        var tmp;
                        if (match === "istrue") {
                          Curry._1(dispatch, /* ShowTotal */Block.__(25, [
                                  response.data.value,
                                  i
                                ]));
                          tmp = Curry._1(dispatch, /* ActionShowProgress */1);
  ...
  var changeFirst = React.useCallback((function (value) {
          return (function (i) {
              return Curry._1(dispatch, /* ChangeFirst */Block.__(26, [
                            value,
                            i
                          ]));
            });
  ...
  var changeFinal = React.useCallback((function (value) {
          return (function (i) {
              return Curry._1(dispatch, /* ChangeFinal */Block.__(27, [
                            value,
                            i
                          ]));
            });
  ...
  var removeFile = React.useCallback((function (path) {
          return (function (original, encryption, extension, first, $$final, i) {
              ...
              Axiosapi$BtsCore.Files.remove(Data$BtsCore.rFileData(path, original, encryption, extension, first, $$final, localStorage.getItem("newid"))).then((function (response) {
                        ...
                        var tmp;
                        if (match === "istrue") {
                          Curry._1(dispatch, /* RemovePage */Block.__(28, [
                                  response.data.value,
                                  i
                                ]));
                          tmp = Curry._1(dispatch, /* ActionShowProgress */1);
  ...
  var changeBody = React.useCallback((function (value) {
          return (function (i) {
              return Curry._1(dispatch, /* ChangeBody */Block.__(29, [
                            value,
                            i
                          ]));
            });
  ...
  var changeReleaseDate = React.useCallback((function (value) {
          return (function (i) {
              return Curry._1(dispatch, /* ChangeReleaseDate */Block.__(30, [
                            value,
                            i
                          ]));
            });
  ...
  var switchLimit = React.useCallback((function (i) {
          return Curry._1(dispatch, /* SwitchLimit */Block.__(31, [i]));
        }));
  var changeEndDate = React.useCallback((function (value) {
          return (function (i) {
              return Curry._1(dispatch, /* ChangeEndDate */Block.__(32, [
                            value,
                            i
                          ]));
            });
