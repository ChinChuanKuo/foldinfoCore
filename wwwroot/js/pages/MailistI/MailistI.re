...
let initialState = {
  ...
  export: false,
  tabitems: [
    {showTab: false, tabImage: transmissionBlack},
    {showTab: false, tabImage: factoryBlack},
    {showTab: true, tabImage: fileCopyBlack},
  ],
  index: 2,
  items: [||],
  showFull: false,
...
let make = _ => {
  ...
  let clickItemTab =
    useCallback(i =>
      if (i == 0) {
        mailistRPath |> ReasonReactRouter.push;
      } else if (i == 2) {
