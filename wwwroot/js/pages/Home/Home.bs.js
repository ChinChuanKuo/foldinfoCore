  ...
  if (typeof action === "number") {
    ...
    switch (action.tag | 0) {
      ...
      case /* ShowAnimationFull */6 :
          ...
          newrecord$13.index = 0;
          newrecord$13.formTitle = action[2];
          newrecord$13.formId = action[1];
          newrecord$13.formIndex = action[0];
          newrecord$13.showFull = !state.showFull;
          return newrecord$13;
      case /* ShowRecord */7 :
          var newrecord$14 = Caml_obj.caml_obj_dup(state);
          newrecord$14.showRecord = action[0];
          return newrecord$14;
      case /* ClickRecordItems */8 :
          var newrecord$15 = Caml_obj.caml_obj_dup(state);
          newrecord$15.recorditems = action[0];
          return newrecord$15;
      case /* ChangeRecord */9 :
      ...
      case /* ClearItem */15 :
          ...
          newrecord$22.items = state.items.filter((function (item) {
                  return item.ids !== id;
                }));
          newrecord$22.itemCount = state.itemCount - 1 | 0;
          return newrecord$22;
      case /* SettingItem */16 :
      ...
      case /* ClickItemTab */17 :
          ...
          newrecord$24.index = index$3;
          newrecord$24.tabitems = List.mapi((function (i, tabitem) {
                  return {
                          showTab: index$3 === i,
      ...
      case /* SettingPhotoItems */18 :
          ...
          newrecord$25.photoitems = action[0];
          return newrecord$25;
      ...
      case /* ShowDrop */68 :
          ...
          newrecord$75.showDrop = action[0];
          return newrecord$75;
      case /* AddPhotoItem */69 :
          var newrecord$76 = Caml_obj.caml_obj_dup(state);
          newrecord$76.photoitems = $$Array.append(state.photoitems, newitem(state.photoitems.length + 1 | 0, action[0], action[1], action[2], action[3], action[4], action[5], action[6], action[7], action[8]));
          return newrecord$76;
      case /* ActionPhotoItem */70 :
          var index$53 = action[0];
          var newrecord$77 = Caml_obj.caml_obj_dup(state);
          newrecord$77.photoitems = $$Array.mapi((function (i, photoitem) {
                  if (index$53 === i) {
                    return {
      ...
      case /* SendAnimationFull */71 :
          ...
          newrecord$78.items = $$Array.mapi((function (i, item) {
                  if (index$54 !== i) {
                    return item;
                  }
                  var newrecord = Caml_obj.caml_obj_dup(item);
      ...
      case /* ClearAnimationFull */72 :
          ...
          newrecord$79.items = state.items.filter((function (item) {
                  return item.ids !== id$1;
                }));
          newrecord$79.itemCount = state.itemCount - 1 | 0;
          return newrecord$79;
      case /* SettingFileItem */73 :
          var newrecord$80 = Caml_obj.caml_obj_dup(state);
          newrecord$80.fileSrc = action[3];
          newrecord$80.filePath = action[2];
          newrecord$80.fileTile = action[1];
          newrecord$80.fileId = action[0];
          newrecord$80.showFileFull = !state.showFileFull;
          newrecord$80.showFull = !state.showFull;
          return newrecord$80;
      case /* SettingPhotoItem */74 :
          var newrecord$81 = Caml_obj.caml_obj_dup(state);
          newrecord$81.photoSrc = action[6];
          newrecord$81.photoPath = action[5];
          newrecord$81.photoVideo = action[4];
          newrecord$81.photoAudio = action[3];
          newrecord$81.photoImage = action[2];
          newrecord$81.photoTile = action[1];
          newrecord$81.photoId = action[0];
          newrecord$81.showPhotoFull = !state.showPhotoFull;
          newrecord$81.showFull = !state.showFull;
          return newrecord$81;
      case /* ActionSnackBar */75 :
          var newrecord$82 = Caml_obj.caml_obj_dup(state);
          newrecord$82.youtubeText = action[0];
          newrecord$82.showYoutube = action[1];
          return newrecord$82;
